...
import { Alert, Box, Card, CardContent, CircularProgress, Container, FormControl, InputLabel, MenuItem, Select, Stack, Table, TableBody, TableCell, TableHead, TableRow, Typography } from "@mui/material";
...
export default function RoundPage() {
    ...
    const [round, setRound] = useState<number>(
        Number.isFinite(initial) && initial > 0 ? initial : 1
    );
