...
export const getMatchPlayerIndexRoundNumber = (
  ...
  return axios.get(`http://localhost:63069/match/${playerIndex}/${roundNumber}`, options);
};
...
export const getGetMatchPlayerIndexRoundNumberQueryKey = (
  ...
  return [`http://localhost:63069/match/${playerIndex}/${roundNumber}`] as const;
};
...
export const getMatchRemainingParticipantCountRoundsPlayed = (
  ...
  return axios.get(
    `http://localhost:63069/match/remaining/${participantCount}/${roundsPlayed}`,
    options,
  );
};
...
export const getGetMatchRemainingParticipantCountRoundsPlayedQueryKey = (
  ...
  return [`http://localhost:63069/match/remaining/${participantCount}/${roundsPlayed}`] as const;
};
...
export const getParticipants = (
  ...
  return axios.get(`http://localhost:63069/participants`, options);
};

export const getGetParticipantsQueryKey = () => {
  return [`http://localhost:63069/participants`] as const;
};
...
export const getPlayerPlayerIndexSchedule = (
  ...
  return axios.get(`http://localhost:63069/player/${playerIndex}/schedule`, options);
};

export const getGetPlayerPlayerIndexScheduleQueryKey = (playerIndex?: number) => {
  return [`http://localhost:63069/player/${playerIndex}/schedule`] as const;
};
...
export const getPlayerPlayerIndexRound = (
  ...
  return axios.get(`http://localhost:63069/player/${playerIndex}/${round}`, options);
};

export const getGetPlayerPlayerIndexRoundQueryKey = (playerIndex?: number, round?: number) => {
  return [`http://localhost:63069/player/${playerIndex}/${round}`] as const;
};
...
export const getRoundsMax = (
  ...
  return axios.get(`http://localhost:63069/rounds/max`, {
    ...options,
...
export const getGetRoundsMaxQueryKey = (params?: GetRoundsMaxParams) => {
  return [`http://localhost:63069/rounds/max`, ...(params ? [params] : [])] as const;
};
...
export const getRoundsRoundNumber = (
  ...
  return axios.get(`http://localhost:63069/rounds/${roundNumber}`, options);
};

export const getGetRoundsRoundNumberQueryKey = (roundNumber?: number) => {
  return [`http://localhost:63069/rounds/${roundNumber}`] as const;
};
